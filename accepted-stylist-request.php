...
// Fetch all stylist requests from the database
// Fetch and display only requests with status = "Accepted"
$stmt = $conn->prepare("SELECT * FROM stylist WHERE stylist_status = 'Accepted'");
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>Email</th>
                        <th>Status</th>
                        <th>Remark Date </th> <!-- Add this column -->
                    </tr>
                </thead>
                <tbody>
                    <?php
                $cnt = 1; // Initialize counter variable
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['stylist_remarkDate']; ?></td> <!-- Display remark date -->
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
