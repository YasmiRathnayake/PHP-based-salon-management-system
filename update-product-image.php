    ...
    if($check !== false && in_array($imageFileType, $allowed_extensions)) {
        if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
            ...
            if($stmt->execute()) {
                ...
                echo "<script>window.location.href='edit-product.php?editid=$sid'</script>";
            } else {
...
<?php 
    ...
    <section id="add-product" class="my-5 py-5">
        <div class="container text-center mt-3 pt-5">
            <h2 class="form-weight-bold">Update Salon Product Image</h2>
            <hr class="mx-auto">
        </div>
        ...
        <div class="mx-auto container">
            <form method="POST" id="update-image-form" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <img src="<?php echo $row['product_image'] ?? 'default_image_path_here.jpg'; ?>" width="50%" height="50%"> <br> <br>
                </div>
                ...
                <div class="form-group">
                    <input type="hidden" name="product_id" value="<?php echo $sid; ?>">
                    <input type="submit" name="submit" class="btn btn-default" value="Update Image"/>
                </div>

                <div class="form-group">
                    <a id="login-url" class="btn" href="edit-product.php">Go Back</a>
                </div>
            </form>
        </div>
    </section>
